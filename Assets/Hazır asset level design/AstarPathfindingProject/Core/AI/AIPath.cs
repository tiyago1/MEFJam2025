    ...
    public partial class AIPath : AIBase, IAstarAI
    {
        ...
        public bool reachedDestination
        {
            get
            {
                ...
                if (!interpolator.valid || remainingDistance + movementPlane.ToPlane(destination - interpolator.endPoint).magnitude >
        ...
        {
            get { return interpolator.valid ? interpolator.endPoint : destination; }
        }
